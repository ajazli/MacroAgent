...
async def _post_init(application: Application) -> None:
    ...
    user_commands = [
        ...
        BotCommand("today",       "Today's summary — /today or /today <name>"),
        ...
        BotCommand("myreport",    "7-day report — /myreport or /myreport <name>"),
        ...
        BotCommand("leaderboard", "Today's calorie leaderboard (everyone)"),
...
def build_application() -> Application:
    ...
    from handlers.targets import cmd_settarget, cmd_cleartarget, cmd_target
    ...
    app.add_handler(CommandHandler("cleartarget", cmd_cleartarget))
